...
import DataToExcel from "../../../components/dataReportChecklistToExcel";
import Pagination from "../../../components/Pagination";

const statusList = ["In Progress", "Complete", "N/A"];

const ChecklistPromoteList = () => {
      ...
      <table className="table-compact table-zebra bg-slate-800 rounded-2xl text-white mt-7">
        ...
        <tbody>
          {reports
            ...
            .filter(
              (report) =>
                report.side_promote === "Checklist Promote" &&
...
export default ChecklistPromoteList;
