...
import AddDocIloanCon from "../../../components/addDocIloanCon";
import Header from "../../../components/Header";
import { Link } from "react-router-dom";
import { DocumentTextIcon } from "@heroicons/react/24/outline";

export default function DocIloanConsumer() {
  const documentType = [
    {
      id: 1,
      name: "Middleware",
      ...
      <div className="w-full p-4">
        ...
        <div className="flex mt-5 w-full bg-slate-800 p-5 rounded-xl text-slate-200">
          <p className="flex">
            ...
            /
            <Link to="/dashboard/doc/iloan/add" className="hover:text-white">
              <span className="flex flex-row mx-1 gap-1 items-center">
                <DocumentTextIcon className="w-5 h-5" /> Document Iloan Consumer
              </span>
            </Link>
            <Link to="/dashboard/doc/iloan/add">
